...
This reads all CSVs in the current directory and uploads them to a single
'rail_events' table in your Digital Ocean managed database.
"""
...
def create_table(conn):
    """Create the rail_events table if it doesn't exist."""
...
def main():
    ...
    parser.add_argument("--db-url", required=True, help="PostgreSQL connection string from Digital Ocean")
